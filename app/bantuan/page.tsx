...
const faqs = [
  ...
  },
  {
    ...
    answer: "Ya, sistem BookNest memungkinkan Anda melakukan reservasi hingga 7 hari ke depan. Silakan pilih tanggal yang diinginkan pada saat pengisian formulir booking."
  },
  {
    ...
    <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-14">
        ...
        <p className="animate-fade-in-up animate-stagger-2 text-[#6D2932] max-w-lg mx-auto leading-relaxed">
          Temukan jawaban atas pertanyaan umum seputar pemesanan, fasilitas, atau laporkan kendala teknis langsung ke tim BookNest.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8 mb-16">
        ...
        <div className="scroll-reveal bg-[#E8D8C4]/80 p-6 rounded-2xl border border-[#C7B7A3] flex items-start gap-4 hover:shadow-md transition-shadow" style={{ transitionDelay: "0.1s" }}>
          ...
          <div>
            ...
            <span className="text-sm font-semibold text-[#561C24]">support@booknest.co.id</span>
          </div>
        </div>
