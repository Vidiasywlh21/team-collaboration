...
export default function Footer({ variant = "default" }: { variant?: "default" | "maroon" }) {
  if (variant === "maroon") {
    return (
      <footer className="border-t border-[#4a1520] py-8 mt-16 text-sm bg-[#561C24]">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
    ...
    <p className="text-xs text-[#E8D8C4]/70">
      &copy; {new Date().getFullYear()} SinergiSpace Team Collaboration Hub. Hak Cipta Dilindungi.
    </p>
